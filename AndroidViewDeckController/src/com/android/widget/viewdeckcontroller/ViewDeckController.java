 ...
 */
public class ViewDeckController extends ViewGroup {
    ...
    public ViewDeckController(Context context) {
        super(context);
        initViewDeckController();
    }

    public ViewDeckController(Context context, AttributeSet attrs) {
        super(context, attrs);
        initViewDeckController();
    }
    ...
    public void setAdapter(ViewDeckControllerAdapter adapter) {
        if (mAdapter != null) {
            ...
            removeAllViews();
            mCurItem = 1;
            scrollTo((getWidth() + mPageMargin) * 1, 0);
        }
